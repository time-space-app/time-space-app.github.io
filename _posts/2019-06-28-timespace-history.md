...
20140128(화)
나고야 학교 홈페이지에 이번에 개발한  CMS 적용 완료
20140123 수정
...
2013-11-16(토)
커뮤니티에 사업홍보 게시예정(그누보드,제로보드,워드프레스 커뮤니티)
* 홈페이지 제작 사업내용:
1. 일본어 홈페이지 제작해 드립니다.(20페이지-비용:88만원/워드프레스기반 또는 자체CMS솔루션 택일가능)
     -워드프레스 적용예: http://time-space.biz/wordpress/
     -자체CMS 적용예: http://nagoyais.com/ , http://globalaichi.com/wordpress/

옵션1). 일본어 홈페이지내 온라인상담게시판관리(일본어)를 해드립니다.(게시물번역 및 일반page문자수정포함:비용협의)
    - 일본 현지의 아이치국제교육세터가 귀사의 일본어 홈페이지를 관리해 드립니다.
    - 국내및 일본현지 오프라인(외근) 지원시 별도의 인건비용이 발생됩니다.(비용협의)

옵션2) . 일본어모바일홈페이지 저가제공(비용:22만원)
    -적용예: http://time-space.biz/time-space/mobile/  ( 타임스페이스 모바일 홈페이지 )
Ps. 상기가격은 부가세 포함 가격 입니다.

2. 홈페이지구축 과 관리실적:
- 제로보드XE사용: http://globalwing.co.kr/ (글로벌윙 코리아/일본유학 홈페이지제작 )
- 그누보드사용 : http://cjob.or.kr (천안시장애인직업지원센터 홈페이지제작 )
- 워드프레스사용 : http://globalaichi.com/ (글로벌아이치 일본어국제교육센터 홈페이지관리 )
- 자체CMS사용 : http://globalaichi.com/wordpress/ ( 일본기술연수생 홍보 홈페이지제작 )
...
*작업완료-2013-9-24
타임-스페이스 WordPress에 디자인템플릿2 입히기
*작업 완료 http://globalaichi.com/wordpress 
글로벌 아이치에서 한국유학링크를  외국인기능실습생워드프레스템플릿 제작   http://www.business-network.or.jp/ (참조)
